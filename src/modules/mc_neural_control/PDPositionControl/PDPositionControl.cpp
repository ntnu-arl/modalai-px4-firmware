...
Vector3f PDPositionControl::calculateAccelerationPD() const
{
  ...
  // PX4_WARN("pos: ", double(_position(0)), double(_position(1)), double(_position(2)));
	// PX4_WARN("pos_sp: ", double(_position_setpoint(0)), double(_position_setpoint(1)), double(_position_setpoint(2)));
