...
matrix::Vector4f NeuralControl::updateNeural() const
{
  ...
  Vector3f angular_vel_local = frame_transf * frame_transf_2 *_angular_velocity;
  ...
  //PX4_WARN("attitude local: %f %f %f %f", (double)quat_local_attitude(0), (double)quat_local_attitude(1), (double)quat_local_attitude(2), (double)quat_local_attitude(3));
